...
/*Table structure for table `assoc_compras_produtos` */

DROP TABLE IF EXISTS `assoc_compras_produtos`;

CREATE TABLE `assoc_compras_produtos` (
...
/*Data for the table `assoc_compras_produtos` */
