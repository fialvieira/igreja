...
BEGIN
	INSERT INTO categorias_financeira
		(num, nome, descricao, tipo, categoria_mae, ativo, empresa_id, user_id, created, modified)
	VALUES
		(vnum, vnome, vdescricao, vtipo, vcategoria_mae, 'S', vempresa_id, vuser_id, vcreated, vmodified);
