...
/*Table structure for table `assoc_membros_departamentos` */

DROP TABLE IF EXISTS `assoc_membros_departamentos`;

CREATE TABLE `assoc_membros_departamentos` (
  `membro_id` int(11) unsigned NOT NULL,
  `departamento_id` int(11) unsigned NOT NULL,
  `empresa_id` int(11) DEFAULT NULL,
  `user_id` int(11) unsigned DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='Atas*Cadastro de Todas as Atas do Sistema';
...
CREATE TABLE `departamentos` (
  ...
  `modified` datetime DEFAULT NULL COMMENT 'oculto',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='Departamentos*Cadastro Departamentos';
...
CREATE TABLE `enderecos` (
  ...
  `logradouro` text CHARACTER SET latin1 NOT NULL,
  `bairro` text CHARACTER SET latin1 NOT NULL,
  `localidade` text NOT NULL COMMENT 'Cidade',
...
) ENGINE=InnoDB AUTO_INCREMENT=783107 DEFAULT CHARSET=utf8 COMMENT='Endereços*Cadastro Endereços';
...
CREATE TABLE `local` (
  ...
  `e_sede` char(1) NOT NULL DEFAULT 'N',
  `empresa_id` int(11) DEFAULT NULL COMMENT 'oculto',
...
CREATE TABLE `membro` (
  `PK_MEM_COD` int(10) NOT NULL AUTO_INCREMENT,
  `MEM_NOM` varchar(65) DEFAULT NULL,
  `FICHA_MEM_DG` text,
  `FK_MEM_STATUS_FREQ_COD` int(10) DEFAULT NULL,
  `MEM_FK_CON_COD` int(10) DEFAULT NULL,
  `NRO_ANTIGO` int(10) DEFAULT NULL,
  `MEM_ATUALIZAR` bit(1) NOT NULL,
  `MEM_VISITANTE` bit(1) NOT NULL,
  `DT_CADASTRO` timestamp(6) NULL DEFAULT NULL,
  `MEM_FK_USU_COD` int(10) DEFAULT NULL,
  `MEM_TEL` varchar(14) DEFAULT NULL,
  `N_MEM_TEL` bit(1) NOT NULL,
  `MEM_CEL1` varchar(15) DEFAULT NULL,
  `N_MEM_CEL1` bit(1) NOT NULL,
  `MEM_CEL1_WAP` int(10) DEFAULT NULL,
  `MEM_CEL2` varchar(15) DEFAULT NULL,
  `N_MEM_CEL2` bit(1) NOT NULL,
  `MEM_CEL2_WAP` int(10) DEFAULT NULL,
  `MEM_FOTO` text,
  `MEM_FOTO_OK` bit(1) NOT NULL,
  `MEM_CPF` varchar(14) DEFAULT NULL,
  `MEM_RG` varchar(13) DEFAULT NULL,
  `MEM_RG_ORGAO_EXP` varchar(6) DEFAULT NULL,
  `MEM_DT_RG` timestamp(6) NULL DEFAULT NULL,
  `MEM_FK_CID_COD_NAT` int(10) DEFAULT NULL,
  `MEM_NACIONALIDADE` varchar(15) DEFAULT NULL,
  `MEM_DT_NASC` date DEFAULT NULL,
  `N_MEM_DT_NASC` bit(1) NOT NULL,
  `MEM_DT_NIVER` timestamp(6) NULL DEFAULT NULL,
  `MEM_MAIOR` varchar(4) DEFAULT NULL,
  `MEM_PAI` varchar(65) DEFAULT NULL,
  `MEM_MAE` varchar(65) DEFAULT NULL,
  `MEM_EST_CIVIL` varchar(15) DEFAULT NULL,
  `MEM_DT_CAS` timestamp(6) NULL DEFAULT NULL,
  `N_MEM_DT_CAS` bit(1) NOT NULL,
  `MEM_CONJUGE` varchar(50) DEFAULT NULL,
  `MEM_SEXO` varchar(1) DEFAULT NULL,
  `MEM_LOGRADOURO` varchar(80) DEFAULT NULL,
  `N_MEM_LOGRADOURO` bit(1) NOT NULL,
  `MEM_NRO` varchar(15) DEFAULT NULL,
  `MEM_COMPLEMENTO` varchar(30) DEFAULT NULL,
  `FK_MEM_BAI` int(10) DEFAULT NULL,
  `MEM_BAIRRO` varchar(45) DEFAULT NULL,
  `FK_MEM_CID` int(10) DEFAULT NULL,
  `MEM_CEP` varchar(10) DEFAULT NULL,
  `MEM_EMAIL_1` varchar(60) DEFAULT NULL,
  `N_MEM_EMAIL_1` bit(1) NOT NULL,
  `MEM_EMAIL_2` varchar(60) DEFAULT NULL,
  `N_MEM_EMAIL_2` bit(1) NOT NULL,
  `MEM_FACEBOOK` varchar(50) DEFAULT NULL,
  `N_MEM_FACEBOOK` bit(1) NOT NULL,
  `MEM_FK_END_COD_RES` int(10) DEFAULT NULL,
  `N_LOG_RES` varchar(5) DEFAULT NULL,
  `MEM_LOGRADOURO_COM` varchar(80) DEFAULT NULL,
  `MEM_NRO_COM` varchar(5) DEFAULT NULL,
  `MEM_COMPLEMENTO_COM` varchar(30) DEFAULT NULL,
  `MEM_BAIRRO_COM` varchar(45) DEFAULT NULL,
  `MEM_CIDADE_COM` varchar(25) DEFAULT NULL,
  `MEM_UF_COM` varchar(2) DEFAULT NULL,
  `MEM_CEP_COM` varchar(10) DEFAULT NULL,
  `MEM_FK_END_COD_COM` int(10) DEFAULT NULL,
  `MEM_EMP_TRABALHA` varchar(60) DEFAULT NULL,
  `MEM_TEL_COM` varchar(14) DEFAULT NULL,
  `N_MEM_TEL_COM` bit(1) NOT NULL,
  `MEM_CEL_COM` varchar(15) DEFAULT NULL,
  `N_MEM_CEL_COM` bit(1) NOT NULL,
  `MEM_CEL_COM_WAP` bit(1) NOT NULL,
  `MEM_EMAIL_COM` varchar(60) DEFAULT NULL,
  `N_MEM_EMAIL_COM` bit(1) NOT NULL,
  `MEM_ATI_PROF` varchar(35) DEFAULT NULL,
  `MEM_ATI_PROF_DIVULGA` bit(1) NOT NULL,
  `MEM_GRAU_INSTRU` varchar(29) DEFAULT NULL,
  `MEM_FORMACAO_ACADEMICA` varchar(60) DEFAULT NULL,
  `MEM_COMENTARIO` text,
  `MEM_FICHA` int(10) DEFAULT NULL,
  `MEM_LIVRO` bit(1) NOT NULL,
  PRIMARY KEY (`PK_MEM_COD`)
...
CREATE TABLE `membro_cargos` (
  ...
  `modified` datetime DEFAULT NULL COMMENT 'oculto',
  PRIMARY KEY (`id`),
  KEY `fk_membros_cargos_has_membros_idx` (`membro_id`),
  KEY `fk_membros_cargos_has_cargos_idx` (`cargo_id`),
  CONSTRAINT `fk_membros_cargos_has_cargos` FOREIGN KEY (`cargo_id`) REFERENCES `cargos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_membros_cargos_has_membros` FOREIGN KEY (`membro_id`) REFERENCES `membros` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabela que relaciona os cargos com os membros. Ela é editada';
...
CREATE TABLE `membros` (
  ...
  `enderecos_numero` varchar(45) DEFAULT NULL,
  `enderecos_complemento` varchar(256) DEFAULT NULL,
  `local_id` int(11) unsigned DEFAULT NULL,
  `nucleo_id` int(11) unsigned DEFAULT NULL,
  `user_id` int(11) NOT NULL COMMENT 'oculto',
  `created` datetime DEFAULT NULL COMMENT 'oculto',
  `modified` datetime DEFAULT NULL COMMENT 'oculto',
  `tipo` char(1) CHARACTER SET latin1 DEFAULT 'M' COMMENT 'combo?Membro;Visitante',
...
) ENGINE=InnoDB AUTO_INCREMENT=4494 DEFAULT CHARSET=utf8 COMMENT='Membros*Cadastro de membros';
...
CREATE TABLE `parametros_sistema` (
  ...
  `id_presidentes_ata` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `id_secretarios_ata` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `temp` (
  ...
  `MEM_FK_CID_COD_NAT` int(10) DEFAULT NULL,
  `MEM_NACIONALIDADE` varchar(15) DEFAULT NULL,
  `MEM_DT_NASC` timestamp(6) NULL DEFAULT NULL,
  `N_MEM_DT_NASC` bit(1) NOT NULL,
  `MEM_DT_NIVER` timestamp(6) NULL DEFAULT NULL,
  `MEM_MAIOR` varchar(4) DEFAULT NULL,
  `MEM_PAI` varchar(65) DEFAULT NULL,
...
/*Table structure for table `xis` */

DROP TABLE IF EXISTS `xis`;

CREATE TABLE `xis` (
  `PK_MEM_CAS` int(11) DEFAULT NULL,
  `Mem_Bodas` varchar(255) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/* Function  structure for function  `fn_remove_accents` */

/*!50003 DROP FUNCTION IF EXISTS `fn_remove_accents` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_remove_accents`( textvalue VARCHAR(10000) ) RETURNS varchar(10000) CHARSET utf8
BEGIN
...
/* Procedure structure for procedure `cargos_seleciona_todos` */

/*!50003 DROP PROCEDURE IF EXISTS  `cargos_seleciona_todos` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `cargos_seleciona_todos`(
				vativo CHAR(1),
        vempresa INT(11)
)
BEGIN
...
/* Procedure structure for procedure `cargo_altera_status` */

/*!50003 DROP PROCEDURE IF EXISTS  `cargo_altera_status` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `cargo_altera_status`(
	vcodigo 	INT(11),
        vempresas_id 	INT(11),
        vativo 		CHAR(1),
        vuser_id 	INT(11),
...
BEGIN
	INSERT INTO cargos
	(nome, descricao, abreviacao, tipo_comissao, ativo, empresa_id, user_id, created, modified)
	VALUES
	(vnome, vdescricao, vabreviacao, vtipo_comissao, vativo, vempresa_id, vuser_id, vcreated, vmodified);
	SELECT LAST_INSERT_ID() id;
END */$$
DELIMITER ;
...
/* Procedure structure for procedure `churchs_seleciona` */

/*!50003 DROP PROCEDURE IF EXISTS  `churchs_seleciona` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `churchs_seleciona`(
...
/* Procedure structure for procedure `church_altera` */

/*!50003 DROP PROCEDURE IF EXISTS  `church_altera` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `church_altera`(
	vid INT(11),
        vnome VARCHAR(150),
        vcnpj VARCHAR(14),
...
/* Procedure structure for procedure `church_insere` */

/*!50003 DROP PROCEDURE IF EXISTS  `church_insere` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `church_insere`(
	vnome VARCHAR(150),
        vcnpj VARCHAR(14),
        vtelefone VARCHAR(15),
        vendereco VARCHAR(150),
...
/* Procedure structure for procedure `church_seleciona` */

/*!50003 DROP PROCEDURE IF EXISTS  `church_seleciona` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `church_seleciona`(
	vid INT(11)
)
BEGIN
	SELECT *
...
/* Procedure structure for procedure `departamento_altera_status` */

/*!50003 DROP PROCEDURE IF EXISTS  `departamento_altera_status` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `departamento_altera_status`(
	vcodigo 	INT(11),
        vempresas_id 	INT(11),
        vativo 		CHAR(1),
        vuser_id 	INT(11),
...
/* Procedure structure for procedure `dom_altera_status` */

/*!50003 DROP PROCEDURE IF EXISTS  `dom_altera_status` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `dom_altera_status`(
	vcodigo 	INT(11),
        vempresas_id 	INT(11),
        vativo 		CHAR(1),
        vuser_id 	INT(11),
...
BEGIN
	IF vativo IS NULL THEN
		...
		ORDER BY T1.modified DESC, T1.nome ASC
		LIMIT 50;
	ELSEIF vativo = 'S' THEN
		SELECT T1.*,
		       T2.sigla estado_descricao,
...
/* Procedure structure for procedure `membro_deps_inte_sel` */

/*!50003 DROP PROCEDURE IF EXISTS  `membro_deps_inte_sel` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `membro_deps_inte_sel`(
	vid 		INT(11),
	vempresa_id	INT(11)
)
BEGIN
...
/* Procedure structure for procedure `tb_bloco_altera` */

/*!50003 DROP PROCEDURE IF EXISTS  `tb_bloco_altera` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `tb_bloco_altera`(
	vblo_co_bloco INT(11),
        vblo_tx_descricao VARCHAR(45),
        vcon_co_condominio INT(11)
)
BEGIN
	UPDATE tb_bloco
	SET
	blo_tx_descricao = vblo_tx_descricao
	WHERE blo_co_bloco = vblo_co_bloco
        AND con_co_condominio = vcon_co_condominio;
END */$$
DELIMITER ;

/* Procedure structure for procedure `tb_bloco_insere` */

/*!50003 DROP PROCEDURE IF EXISTS  `tb_bloco_insere` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `tb_bloco_insere`(
	vblo_tx_descricao VARCHAR(45),
	vcon_co_condominio int(11)
)
BEGIN
	INSERT INTO tb_bloco
	(blo_tx_descricao,con_co_condominio)
	VALUES
	(vblo_tx_descricao,vcon_co_condominio);
	SELECT LAST_INSERT_ID() blo_co_bloco;
END */$$
DELIMITER ;

/* Procedure structure for procedure `tb_bloco_seleciona` */

/*!50003 DROP PROCEDURE IF EXISTS  `tb_bloco_seleciona` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `tb_bloco_seleciona`(
	vblo_co_bloco INT(11),
        vcon_co_condominio INT(11)
)
BEGIN
...
/* Procedure structure for procedure `tb_bloco_seleciona_todos` */

/*!50003 DROP PROCEDURE IF EXISTS  `tb_bloco_seleciona_todos` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `tb_bloco_seleciona_todos`(
	vativo CHAR(1)
)
BEGIN
	SELECT T1.*
...
/* Procedure structure for procedure `users_church_insere` */

/*!50003 DROP PROCEDURE IF EXISTS  `users_church_insere` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `users_church_insere`(
	vchurchs_id	INT(11),
	vusers_id 	INT(11)
)
BEGIN
	insert into assoc_churchs_users
	(churchs_id, users_id)
	values
	(vchurchs_id, vusers_id);
END */$$
DELIMITER ;
