...
<?php $template->iniCss() ?>
<link rel="stylesheet" href="tipo_biblioteca.css">
<?php $template->fimCss() ?>

<?php $template->iniMain() ?>

<!--<h1><a href="ndex.php">Tipo Biblioteca</a> / <?=(!$filtro[0]) ? "Novo" : "Alterar"?> </h1>-->
<h1><a onclick="voltar()">Tipo Biblioteca</a> / <?=(!$filtro[0]) ? "Novo" : "Alterar"?> </h1>
<div class="container">
    <div>
        <div class="card">
            <div class="campos">
                <input type="hidden" id="tabela" value="tipo_biblioteca">
    ...
    <?php $template->iniJs() ?>
    <script src="tipo_biblioteca.js"></script>
    <?php $template->fimJs() ?>
